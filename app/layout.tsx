...
export const metadata: Metadata = {
  ...
  keywords: '화상영어, 화상영어회화, 화상영어추천, 화상영어가격, 영어회화, 영어스피킹, 원어민영어, 성인영어회화, 직장인영어회화, 온라인영어학원, 실전영어회화, 아침영어회화, 화상영어무료체험, YES화상영어, TIA영어, 캠블리, 링글, 스픽, 엔구, 민트영어, 어메이징토커, 프렙, 튜터링, 링고다, 버블링, 아이튜터, 민병철유폰, 야나두, 시원스쿨, 리얼클래스',
  authors: [{ name: 'YES' }],
  creator: 'YES',
  publisher: 'YES',
  formatDetection: {
