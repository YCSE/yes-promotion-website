...
const TiaModal = ({ isOpen, onClose }: TiaModalProps) => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'TIA는 단순한 챗봇이 아닙니다. 최신 AI모델을 기반으로 교사의 피드백을 깊이 있게 분석하여 학생의 약점을 정확히 파악하고 맞춤형 학습 전략을 제시합니다.',
    ...
    },
    {
      ...
      description: 'TIA는 한국 학생들을 위해 특별히 설계되었습니다. K-POP과 한국 문화를 이해하며, 필요시 한국어로 소통이 가능한 진정한 AI 영어선생님입니다.',
      highlight: '문화적 공감',
      details: [
        '한국어 ↔ 영어 즉시 전환',
        'K-POP 등 관심사 공유',
